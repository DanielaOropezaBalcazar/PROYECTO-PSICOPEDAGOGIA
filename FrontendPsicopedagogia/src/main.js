...
const routes = [
  ...
  {
    path: "/pesta&ntilde;a-programa-integra-psicopedagogia",
    component: integraComponente,
  },
  {
    path: "/pesta&ntilde;a-red-psicopedagogia",
    component: redPsicopedagogiaComponent,
  },
  ...
  {
    path: "/pesta&ntilde;a-sociedad-cient&iacute;fica-Inpsicopedia",
    component: InpsicopediaComponente,
  },
  ...
  {
    path: "/pesta&ntilde;a-centro-estudiantes-componente",
    component: CentroEstComponente,
  },
  { path: "/pesta&ntilde;a-UCB-games", component: UCBGamesComponente },
  {
    path: "/pesta&ntilde;a-torneo-intercarreras",
    component: IntercarrerasComponente,
  },
  {
    path: "/pesta&ntilde;a-obras-sociales-con-iglesia",
    component: obrasIglesiaComponente,
  },
