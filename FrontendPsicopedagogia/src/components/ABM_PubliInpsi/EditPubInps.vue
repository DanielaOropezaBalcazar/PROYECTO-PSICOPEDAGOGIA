  ...
  <div class="modal" v-if="show">
    <div class="modal-content">
      ...
      <form @submit.prevent="submitForm">
        ...
        <select v-model="formData.integrantes_inpsicopedia_id_integrante" required>
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        const response = await fetch(`http://localhost:3000/pub-inpsicopedia/update/${this.publicacion.id_publicacion}`, {
          method: 'PUT',
          headers: {
