<template>
  <div class="modal" v-if="show">
    <div class="modal-content">
      ...
      <h2 style="text-align: center;">Crear publicacion Inpsicopedia</h2>
...
export default {
  ...
  data() {
    return {
      formData: {
        ...
        imagen: '',
        descripcion: '',
        integrantes_zona_aprendizaje_id_integrante: '',
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        const response = await fetch('http://localhost:3000/pub-zona-aprendizaje/create', {
          method: 'POST',
          headers: {
