...
<body>
  ...
  <div class="container mt-4">
    ...
    <div class="container mt-4">
      ...
      <footer class="text-center mt-4" style="background-color: #8438FF; color: #333; padding-top: 20px;">
  <div style="display: flex; justify-content: center;">
    <div style="margin-right: 20px; text-align: center;">
      <a href="https://www.facebook.com/tucuenta" target="_blank" style="color:white; display: block; text-decoration: none;">
        <img src="../images/Contactos/facebook.png" alt="Facebook" width="50" height="50" style="margin-bottom: 10px;">
        Facebook
      </a>
    </div>
    <div style="margin-right: 20px; text-align: center;">
      <a href="https://twitter.com/tucuenta" target="_blank" style="color:white; display: block; text-decoration: none;">
        <img src="../images/Contactos/x.png" alt="Twitter" width="50" height="50" style="margin-bottom: 10px;">
        Twitter
      </a>
    </div>
    <div style="text-align: center;">
      <a href="https://www.instagram.com/tucuenta" target="_blank" style="color:white; display: block; text-decoration: none;">
        <img src="../images/Contactos/instagram.png" alt="Instagram" width="50" height="50" style="margin-bottom: 10px;">
        Instagram
      </a>
    </div>
  </div>
